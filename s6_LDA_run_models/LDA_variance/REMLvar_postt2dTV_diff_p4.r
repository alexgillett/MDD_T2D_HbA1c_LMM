...
### Extract the 10 imputed datasets required (forth set of 10 here)
for(i in 1:10){
...
### Run model:
fit_postt2dTV_diff_REML4 <- with(mi_list4,
...
### save output
save.image(file=paste(analysis_dir, "model_output/var_postt2dTV_diffREML4.RData", sep=""))
